...
#error USE_USB_CDC defined...somewhere
Uart_t UartUsb;
#endif
...
//#warning "Commented for test!"
  ...
  SpiInit( &SX1276.Spi, SPI_1, RADIO_MOSI, RADIO_MISO, RADIO_SCLK, NC ); //RADIO_NSS doesn't work, infinite loop on init
  SX1276IoInit( );
...
//	GpioInit( &ioPin, UNUSEDPINPB8, PIN_ANALOGIC, PIN_PUSH_PULL, PIN_NO_PULL, 0 ); LED
...
/**
  ...
  *
  * \note exits the function when waking up
  */
